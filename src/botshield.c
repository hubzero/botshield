...
static const command_rec bs_cmds[] = {
    ...
    AP_INIT_RAW_ARGS("<BotShieldChallengePage", bs_open_page, NULL,
                 ...
                 "robot\", HTML-escaped at render; the interactive and "
                 "captcha tiers), BotShieldNotice (what the "
                 "self-solving non-interactive tier says instead, "
                 "default \"Verifying you are human...\" -- that tier "
                 "offers no control, so its line is a status and takes "
                 "its own directive), BotShieldLogoFile "
    ...
    AP_INIT_TAKE_ARGV("BotShieldRule",
                 ...
                 "accesslog=on|off, flagip=<bit>, flagsession=<bit>, "
