...
const bs_browser_template bs_browser_templates[] = {
    { "Mozilla/X (Android X; Mobile; rv:X) Gecko/X Firefox/X", "firefox" },
    { "Mozilla/X (Linux; Android X; K) AppleWebKit/X (KHTML, like Gecko) Chrome/X Mobile Safari/X", "chrome-mobile" },
    { "Mozilla/X (Linux; Android X; K) AppleWebKit/X (KHTML, like Gecko) Chrome/X Mobile Safari/X EdgA/X", "edge-mobile" },
    { "Mozilla/X (Linux; Android X; K) AppleWebKit/X (KHTML, like Gecko) Chrome/X Safari/X", "chrome" },
    { "Mozilla/X (Linux; Android X; K) AppleWebKit/X (KHTML, like Gecko) SamsungBrowser/X Chrome/X Mobile Safari/X", "samsung" },
    { "Mozilla/X (Linux; Android X; Pixel X Pro) AppleWebKit/X (KHTML, like Gecko) Chrome/X Mobile Safari/X OPR/X", "opera" },
    { "Mozilla/X (Linux; Android X; SM-GXB) AppleWebKit/X (KHTML, like Gecko) Chrome/X Mobile Safari/X EdgA/X", "edge-mobile" },
    { "Mozilla/X (Linux; Android X; SM-JXG) AppleWebKit/X (KHTML, like Gecko) Chrome/X Mobile Safari/X EdgA/X", "edge-mobile" },
    { "Mozilla/X (Linux; Android X; SM-SXB) AppleWebKit/X (KHTML, like Gecko) Chrome/X Mobile Safari/X OPR/X", "opera" },
    { "Mozilla/X (Linux; Android X; XRI Build/UKQX; wv) AppleWebKit/X (KHTML, like Gecko) Version/X Chrome/X Mobile Safari/X median", "median" },
    ...
    { "Mozilla/X (Windows NT X; WinX; xX) AppleWebKit/X (KHTML, like Gecko) obsidian/X Chrome/X Electron/X Safari/X", "obsidian" },
    ...
    { "Mozilla/X (iPad; CPU OS X like Mac OS X) AppleWebKit/X (KHTML, like Gecko) Version/X Mobile/XEX Safari/X", "safari-mobile" },
    { "Mozilla/X (iPhone; CPU iPhone OS X like Mac OS X) AppleWebKit/X (KHTML, like Gecko) CriOS/X Mobile/XEX Safari/X", "chrome-ios" },
    { "Mozilla/X (iPhone; CPU iPhone OS X like Mac OS X) AppleWebKit/X (KHTML, like Gecko) Mobile/XEX", "ios-webview" },
    { "Mozilla/X (iPhone; CPU iPhone OS X like Mac OS X) AppleWebKit/X (KHTML, like Gecko) Version/X Mobile/XEX Safari/X", "safari-mobile" },
    { NULL, NULL }
};
