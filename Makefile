...
EXTRA_SRC := src/robots.c src/shm.c src/crypto.c src/allowlist.c src/metrics.c src/challenge.c src/cookie.c src/load.c src/silent.c src/captcha.c src/bridge.c
